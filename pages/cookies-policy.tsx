  ...
  return (
    <Page title="Cookies policy">
      <CookiesPolicyContainer>
        <RichText>
        <h1>Cookie Policy for cosmicuplift</h1>

<p>This is the Cookie Policy for cosmicuplift, accessible from https://cosmicuplift.com/</p>
...
<ul>
<li>Email: info@cosmicuplift.com</li>
